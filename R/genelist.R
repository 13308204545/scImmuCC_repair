...
#usethis::use_data(layer1_genelist,overwrite = T)
#usethis::use_data(layer0_genelist,overwrite = T)
#usethis::use_data(Tcell_genelist,overwrite = T)
#usethis::use_data(Bcell_genelist,overwrite = T)
#usethis::use_data(DC_genelist,overwrite = T)
#usethis::use_data(NK_genelist,overwrite = T)
#usethis::use_data(Monocyte_genelist,overwrite = T)
#usethis::use_data(Macrophage_genelist,overwrite = T)
#usethis::use_data(ILC_genelist,overwrite = T)
#usethis::use_data(CD4_genelist,overwrite = T)
#usethis::use_data(CD8_genelist,overwrite = T)
